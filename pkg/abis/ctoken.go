...
// AdminFeeMantissa is a free data retrieval call binding the contract method 0x8d02d9a1.
//
// Solidity: function adminFeeMantissa() view returns(uint256)
func (_CToken *CTokenCaller) AdminFeeMantissa(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "adminFeeMantissa")
...
//
// Solidity: function adminFeeMantissa() view returns(uint256)
func (_CToken *CTokenSession) AdminFeeMantissa() (*big.Int, error) {
	return _CToken.Contract.AdminFeeMantissa(&_CToken.CallOpts)
}

// AdminFeeMantissa is a free data retrieval call binding the contract method 0x8d02d9a1.
//
// Solidity: function adminFeeMantissa() view returns(uint256)
func (_CToken *CTokenCallerSession) AdminFeeMantissa() (*big.Int, error) {
	return _CToken.Contract.AdminFeeMantissa(&_CToken.CallOpts)
}
...
func (_CToken *CTokenCaller) AdminHasRights(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "adminHasRights")
...
//
// Solidity: function adminHasRights() view returns(bool)
func (_CToken *CTokenSession) AdminHasRights() (bool, error) {
	return _CToken.Contract.AdminHasRights(&_CToken.CallOpts)
}

// AdminHasRights is a free data retrieval call binding the contract method 0x0a755ec2.
//
// Solidity: function adminHasRights() view returns(bool)
func (_CToken *CTokenCallerSession) AdminHasRights() (bool, error) {
	return _CToken.Contract.AdminHasRights(&_CToken.CallOpts)
}
...
func (_CToken *CTokenCaller) BalanceOfUnderlying(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "balanceOfUnderlying", owner)
...
//
// Solidity: function balanceOfUnderlying(address owner) view returns(uint256)
func (_CToken *CTokenSession) BalanceOfUnderlying(owner common.Address) (*big.Int, error) {
	return _CToken.Contract.BalanceOfUnderlying(&_CToken.CallOpts, owner)
}

// BalanceOfUnderlying is a free data retrieval call binding the contract method 0x3af9e669.
//
// Solidity: function balanceOfUnderlying(address owner) view returns(uint256)
func (_CToken *CTokenCallerSession) BalanceOfUnderlying(owner common.Address) (*big.Int, error) {
	return _CToken.Contract.BalanceOfUnderlying(&_CToken.CallOpts, owner)
}
...
func (_CToken *CTokenCaller) FuseAdminHasRights(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "fuseAdminHasRights")
...
//
// Solidity: function fuseAdminHasRights() view returns(bool)
func (_CToken *CTokenSession) FuseAdminHasRights() (bool, error) {
	return _CToken.Contract.FuseAdminHasRights(&_CToken.CallOpts)
}

// FuseAdminHasRights is a free data retrieval call binding the contract method 0x2f1069ba.
//
// Solidity: function fuseAdminHasRights() view returns(bool)
func (_CToken *CTokenCallerSession) FuseAdminHasRights() (bool, error) {
	return _CToken.Contract.FuseAdminHasRights(&_CToken.CallOpts)
}

// FuseFeeMantissa is a free data retrieval call binding the contract method 0xdbfe7c19.
//
// Solidity: function fuseFeeMantissa() view returns(uint256)
func (_CToken *CTokenCaller) FuseFeeMantissa(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "fuseFeeMantissa")
...
//
// Solidity: function fuseFeeMantissa() view returns(uint256)
func (_CToken *CTokenSession) FuseFeeMantissa() (*big.Int, error) {
	return _CToken.Contract.FuseFeeMantissa(&_CToken.CallOpts)
}

// FuseFeeMantissa is a free data retrieval call binding the contract method 0xdbfe7c19.
//
// Solidity: function fuseFeeMantissa() view returns(uint256)
func (_CToken *CTokenCallerSession) FuseFeeMantissa() (*big.Int, error) {
	return _CToken.Contract.FuseFeeMantissa(&_CToken.CallOpts)
}
...
// IsCEther is a free data retrieval call binding the contract method 0xac784ddc.
//
// Solidity: function isCEther() view returns(bool)
func (_CToken *CTokenCaller) IsCEther(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "isCEther")
...
//
// Solidity: function isCEther() view returns(bool)
func (_CToken *CTokenSession) IsCEther() (bool, error) {
	return _CToken.Contract.IsCEther(&_CToken.CallOpts)
}

// IsCEther is a free data retrieval call binding the contract method 0xac784ddc.
//
// Solidity: function isCEther() view returns(bool)
func (_CToken *CTokenCallerSession) IsCEther() (bool, error) {
	return _CToken.Contract.IsCEther(&_CToken.CallOpts)
}
...
// TotalAdminFees is a free data retrieval call binding the contract method 0x61feacff.
//
// Solidity: function totalAdminFees() view returns(uint256)
func (_CToken *CTokenCaller) TotalAdminFees(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "totalAdminFees")
...
//
// Solidity: function totalAdminFees() view returns(uint256)
func (_CToken *CTokenSession) TotalAdminFees() (*big.Int, error) {
	return _CToken.Contract.TotalAdminFees(&_CToken.CallOpts)
}

// TotalAdminFees is a free data retrieval call binding the contract method 0x61feacff.
//
// Solidity: function totalAdminFees() view returns(uint256)
func (_CToken *CTokenCallerSession) TotalAdminFees() (*big.Int, error) {
	return _CToken.Contract.TotalAdminFees(&_CToken.CallOpts)
}
...
// TotalFuseFees is a free data retrieval call binding the contract method 0xdc028ab1.
//
// Solidity: function totalFuseFees() view returns(uint256)
func (_CToken *CTokenCaller) TotalFuseFees(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _CToken.contract.Call(opts, &out, "totalFuseFees")
...
//
// Solidity: function totalFuseFees() view returns(uint256)
func (_CToken *CTokenSession) TotalFuseFees() (*big.Int, error) {
	return _CToken.Contract.TotalFuseFees(&_CToken.CallOpts)
}

// TotalFuseFees is a free data retrieval call binding the contract method 0xdc028ab1.
//
// Solidity: function totalFuseFees() view returns(uint256)
func (_CToken *CTokenCallerSession) TotalFuseFees() (*big.Int, error) {
	return _CToken.Contract.TotalFuseFees(&_CToken.CallOpts)
}
...
func (_CToken *CTokenTransactor) BecomeImplementation(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_becomeImplementation", data)
}

// BecomeImplementation is a paid mutator transaction binding the contract method 0x56e67728.
//
// Solidity: function _becomeImplementation(bytes data) returns()
func (_CToken *CTokenSession) BecomeImplementation(data []byte) (*types.Transaction, error) {
	return _CToken.Contract.BecomeImplementation(&_CToken.TransactOpts, data)
}

// BecomeImplementation is a paid mutator transaction binding the contract method 0x56e67728.
//
// Solidity: function _becomeImplementation(bytes data) returns()
func (_CToken *CTokenTransactorSession) BecomeImplementation(data []byte) (*types.Transaction, error) {
	return _CToken.Contract.BecomeImplementation(&_CToken.TransactOpts, data)
}
...
// RenounceAdminRights is a paid mutator transaction binding the contract method 0xbf0f1d7b.
//
// Solidity: function _renounceAdminRights() returns(uint256)
func (_CToken *CTokenTransactor) RenounceAdminRights(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_renounceAdminRights")
}

// RenounceAdminRights is a paid mutator transaction binding the contract method 0xbf0f1d7b.
//
// Solidity: function _renounceAdminRights() returns(uint256)
func (_CToken *CTokenSession) RenounceAdminRights() (*types.Transaction, error) {
	return _CToken.Contract.RenounceAdminRights(&_CToken.TransactOpts)
}

// RenounceAdminRights is a paid mutator transaction binding the contract method 0xbf0f1d7b.
//
// Solidity: function _renounceAdminRights() returns(uint256)
func (_CToken *CTokenTransactorSession) RenounceAdminRights() (*types.Transaction, error) {
	return _CToken.Contract.RenounceAdminRights(&_CToken.TransactOpts)
}

// RenounceFuseAdminRights is a paid mutator transaction binding the contract method 0xe16d2c32.
//
// Solidity: function _renounceFuseAdminRights() returns(uint256)
func (_CToken *CTokenTransactor) RenounceFuseAdminRights(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_renounceFuseAdminRights")
}

// RenounceFuseAdminRights is a paid mutator transaction binding the contract method 0xe16d2c32.
//
// Solidity: function _renounceFuseAdminRights() returns(uint256)
func (_CToken *CTokenSession) RenounceFuseAdminRights() (*types.Transaction, error) {
	return _CToken.Contract.RenounceFuseAdminRights(&_CToken.TransactOpts)
}

// RenounceFuseAdminRights is a paid mutator transaction binding the contract method 0xe16d2c32.
//
// Solidity: function _renounceFuseAdminRights() returns(uint256)
func (_CToken *CTokenTransactorSession) RenounceFuseAdminRights() (*types.Transaction, error) {
	return _CToken.Contract.RenounceFuseAdminRights(&_CToken.TransactOpts)
}
...
func (_CToken *CTokenTransactor) ResignImplementation(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_resignImplementation")
}

// ResignImplementation is a paid mutator transaction binding the contract method 0x153ab505.
//
// Solidity: function _resignImplementation() returns()
func (_CToken *CTokenSession) ResignImplementation() (*types.Transaction, error) {
	return _CToken.Contract.ResignImplementation(&_CToken.TransactOpts)
}

// ResignImplementation is a paid mutator transaction binding the contract method 0x153ab505.
//
// Solidity: function _resignImplementation() returns()
func (_CToken *CTokenTransactorSession) ResignImplementation() (*types.Transaction, error) {
	return _CToken.Contract.ResignImplementation(&_CToken.TransactOpts)
}

// SetAdminFee is a paid mutator transaction binding the contract method 0x91dd36c6.
//
// Solidity: function _setAdminFee(uint256 newAdminFeeMantissa) returns(uint256)
func (_CToken *CTokenTransactor) SetAdminFee(opts *bind.TransactOpts, newAdminFeeMantissa *big.Int) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_setAdminFee", newAdminFeeMantissa)
}

// SetAdminFee is a paid mutator transaction binding the contract method 0x91dd36c6.
//
// Solidity: function _setAdminFee(uint256 newAdminFeeMantissa) returns(uint256)
func (_CToken *CTokenSession) SetAdminFee(newAdminFeeMantissa *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.SetAdminFee(&_CToken.TransactOpts, newAdminFeeMantissa)
}

// SetAdminFee is a paid mutator transaction binding the contract method 0x91dd36c6.
//
// Solidity: function _setAdminFee(uint256 newAdminFeeMantissa) returns(uint256)
func (_CToken *CTokenTransactorSession) SetAdminFee(newAdminFeeMantissa *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.SetAdminFee(&_CToken.TransactOpts, newAdminFeeMantissa)
}
...
// SetFuseFee is a paid mutator transaction binding the contract method 0xc26b1b13.
//
// Solidity: function _setFuseFee() returns(uint256)
func (_CToken *CTokenTransactor) SetFuseFee(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_setFuseFee")
}

// SetFuseFee is a paid mutator transaction binding the contract method 0xc26b1b13.
//
// Solidity: function _setFuseFee() returns(uint256)
func (_CToken *CTokenSession) SetFuseFee() (*types.Transaction, error) {
	return _CToken.Contract.SetFuseFee(&_CToken.TransactOpts)
}

// SetFuseFee is a paid mutator transaction binding the contract method 0xc26b1b13.
//
// Solidity: function _setFuseFee() returns(uint256)
func (_CToken *CTokenTransactorSession) SetFuseFee() (*types.Transaction, error) {
	return _CToken.Contract.SetFuseFee(&_CToken.TransactOpts)
}
...
// WithdrawAdminFees is a paid mutator transaction binding the contract method 0xa7b820df.
//
// Solidity: function _withdrawAdminFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenTransactor) WithdrawAdminFees(opts *bind.TransactOpts, withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_withdrawAdminFees", withdrawAmount)
}

// WithdrawAdminFees is a paid mutator transaction binding the contract method 0xa7b820df.
//
// Solidity: function _withdrawAdminFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenSession) WithdrawAdminFees(withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.WithdrawAdminFees(&_CToken.TransactOpts, withdrawAmount)
}

// WithdrawAdminFees is a paid mutator transaction binding the contract method 0xa7b820df.
//
// Solidity: function _withdrawAdminFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenTransactorSession) WithdrawAdminFees(withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.WithdrawAdminFees(&_CToken.TransactOpts, withdrawAmount)
}

// WithdrawFuseFees is a paid mutator transaction binding the contract method 0xa03dce8d.
//
// Solidity: function _withdrawFuseFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenTransactor) WithdrawFuseFees(opts *bind.TransactOpts, withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "_withdrawFuseFees", withdrawAmount)
}

// WithdrawFuseFees is a paid mutator transaction binding the contract method 0xa03dce8d.
//
// Solidity: function _withdrawFuseFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenSession) WithdrawFuseFees(withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.WithdrawFuseFees(&_CToken.TransactOpts, withdrawAmount)
}

// WithdrawFuseFees is a paid mutator transaction binding the contract method 0xa03dce8d.
//
// Solidity: function _withdrawFuseFees(uint256 withdrawAmount) returns(uint256)
func (_CToken *CTokenTransactorSession) WithdrawFuseFees(withdrawAmount *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.WithdrawFuseFees(&_CToken.TransactOpts, withdrawAmount)
}
...
// Initialize is a paid mutator transaction binding the contract method 0x0f8855e8.
//
// Solidity: function initialize(address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenTransactor) Initialize(opts *bind.TransactOpts, comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "initialize", comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}

// Initialize is a paid mutator transaction binding the contract method 0x0f8855e8.
//
// Solidity: function initialize(address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenSession) Initialize(comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.Initialize(&_CToken.TransactOpts, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}

// Initialize is a paid mutator transaction binding the contract method 0x0f8855e8.
//
// Solidity: function initialize(address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenTransactorSession) Initialize(comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.Initialize(&_CToken.TransactOpts, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}

// Initialize0 is a paid mutator transaction binding the contract method 0x219ef65c.
//
// Solidity: function initialize(address underlying_, address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenTransactor) Initialize0(opts *bind.TransactOpts, underlying_ common.Address, comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.contract.Transact(opts, "initialize0", underlying_, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}

// Initialize0 is a paid mutator transaction binding the contract method 0x219ef65c.
//
// Solidity: function initialize(address underlying_, address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenSession) Initialize0(underlying_ common.Address, comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.Initialize0(&_CToken.TransactOpts, underlying_, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}

// Initialize0 is a paid mutator transaction binding the contract method 0x219ef65c.
//
// Solidity: function initialize(address underlying_, address comptroller_, address interestRateModel_, uint256 initialExchangeRateMantissa_, string name_, string symbol_, uint8 decimals_, uint256 reserveFactorMantissa_, uint256 adminFeeMantissa_) returns()
func (_CToken *CTokenTransactorSession) Initialize0(underlying_ common.Address, comptroller_ common.Address, interestRateModel_ common.Address, initialExchangeRateMantissa_ *big.Int, name_ string, symbol_ string, decimals_ uint8, reserveFactorMantissa_ *big.Int, adminFeeMantissa_ *big.Int) (*types.Transaction, error) {
	return _CToken.Contract.Initialize0(&_CToken.TransactOpts, underlying_, comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, reserveFactorMantissa_, adminFeeMantissa_)
}
...
// CTokenAdminRightsRenouncedIterator is returned from FilterAdminRightsRenounced and is used to iterate over the raw logs and unpacked data for AdminRightsRenounced events raised by the CToken contract.
type CTokenAdminRightsRenouncedIterator struct {
	Event *CTokenAdminRightsRenounced // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CTokenAdminRightsRenouncedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CTokenAdminRightsRenounced)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CTokenAdminRightsRenouncedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CTokenAdminRightsRenouncedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CTokenAdminRightsRenounced represents a AdminRightsRenounced event raised by the CToken contract.
type CTokenAdminRightsRenounced struct {
	Raw types.Log // Blockchain specific contextual infos
}

// FilterAdminRightsRenounced is a free log retrieval operation binding the contract event 0xc8ed31b431dd871a74f7e15bc645f3dbdd94636e59d7633a4407b044524eb459.
//
// Solidity: event AdminRightsRenounced()
func (_CToken *CTokenFilterer) FilterAdminRightsRenounced(opts *bind.FilterOpts) (*CTokenAdminRightsRenouncedIterator, error) {

	logs, sub, err := _CToken.contract.FilterLogs(opts, "AdminRightsRenounced")
	if err != nil {
		return nil, err
	}
	return &CTokenAdminRightsRenouncedIterator{contract: _CToken.contract, event: "AdminRightsRenounced", logs: logs, sub: sub}, nil
}

// WatchAdminRightsRenounced is a free log subscription operation binding the contract event 0xc8ed31b431dd871a74f7e15bc645f3dbdd94636e59d7633a4407b044524eb459.
//
// Solidity: event AdminRightsRenounced()
func (_CToken *CTokenFilterer) WatchAdminRightsRenounced(opts *bind.WatchOpts, sink chan<- *CTokenAdminRightsRenounced) (event.Subscription, error) {

	logs, sub, err := _CToken.contract.WatchLogs(opts, "AdminRightsRenounced")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CTokenAdminRightsRenounced)
				if err := _CToken.contract.UnpackLog(event, "AdminRightsRenounced", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAdminRightsRenounced is a log parse operation binding the contract event 0xc8ed31b431dd871a74f7e15bc645f3dbdd94636e59d7633a4407b044524eb459.
//
// Solidity: event AdminRightsRenounced()
func (_CToken *CTokenFilterer) ParseAdminRightsRenounced(log types.Log) (*CTokenAdminRightsRenounced, error) {
	event := new(CTokenAdminRightsRenounced)
	if err := _CToken.contract.UnpackLog(event, "AdminRightsRenounced", log); err != nil {
		return nil, err
	}
...
// CTokenFuseAdminRightsRenouncedIterator is returned from FilterFuseAdminRightsRenounced and is used to iterate over the raw logs and unpacked data for FuseAdminRightsRenounced events raised by the CToken contract.
type CTokenFuseAdminRightsRenouncedIterator struct {
	Event *CTokenFuseAdminRightsRenounced // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CTokenFuseAdminRightsRenouncedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CTokenFuseAdminRightsRenounced)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CTokenFuseAdminRightsRenouncedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CTokenFuseAdminRightsRenouncedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CTokenFuseAdminRightsRenounced represents a FuseAdminRightsRenounced event raised by the CToken contract.
type CTokenFuseAdminRightsRenounced struct {
	Raw types.Log // Blockchain specific contextual infos
}

// FilterFuseAdminRightsRenounced is a free log retrieval operation binding the contract event 0x9f60987413d3c28e8232c3eec2559453cc8c6805ff81501e344a133944113e35.
//
// Solidity: event FuseAdminRightsRenounced()
func (_CToken *CTokenFilterer) FilterFuseAdminRightsRenounced(opts *bind.FilterOpts) (*CTokenFuseAdminRightsRenouncedIterator, error) {

	logs, sub, err := _CToken.contract.FilterLogs(opts, "FuseAdminRightsRenounced")
	if err != nil {
		return nil, err
	}
	return &CTokenFuseAdminRightsRenouncedIterator{contract: _CToken.contract, event: "FuseAdminRightsRenounced", logs: logs, sub: sub}, nil
}

// WatchFuseAdminRightsRenounced is a free log subscription operation binding the contract event 0x9f60987413d3c28e8232c3eec2559453cc8c6805ff81501e344a133944113e35.
//
// Solidity: event FuseAdminRightsRenounced()
func (_CToken *CTokenFilterer) WatchFuseAdminRightsRenounced(opts *bind.WatchOpts, sink chan<- *CTokenFuseAdminRightsRenounced) (event.Subscription, error) {

	logs, sub, err := _CToken.contract.WatchLogs(opts, "FuseAdminRightsRenounced")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CTokenFuseAdminRightsRenounced)
				if err := _CToken.contract.UnpackLog(event, "FuseAdminRightsRenounced", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseFuseAdminRightsRenounced is a log parse operation binding the contract event 0x9f60987413d3c28e8232c3eec2559453cc8c6805ff81501e344a133944113e35.
//
// Solidity: event FuseAdminRightsRenounced()
func (_CToken *CTokenFilterer) ParseFuseAdminRightsRenounced(log types.Log) (*CTokenFuseAdminRightsRenounced, error) {
	event := new(CTokenFuseAdminRightsRenounced)
	if err := _CToken.contract.UnpackLog(event, "FuseAdminRightsRenounced", log); err != nil {
		return nil, err
	}
...
// CTokenNewAdminFeeIterator is returned from FilterNewAdminFee and is used to iterate over the raw logs and unpacked data for NewAdminFee events raised by the CToken contract.
type CTokenNewAdminFeeIterator struct {
	Event *CTokenNewAdminFee // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CTokenNewAdminFeeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CTokenNewAdminFee)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CTokenNewAdminFeeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CTokenNewAdminFeeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CTokenNewAdminFee represents a NewAdminFee event raised by the CToken contract.
type CTokenNewAdminFee struct {
	OldAdminFeeMantissa *big.Int
	NewAdminFeeMantissa *big.Int
	Raw                 types.Log // Blockchain specific contextual infos
}

// FilterNewAdminFee is a free log retrieval operation binding the contract event 0xcdd0b588250e1398549f79cfdb8217c186688822905d6715b0834ea1c865594a.
//
// Solidity: event NewAdminFee(uint256 oldAdminFeeMantissa, uint256 newAdminFeeMantissa)
func (_CToken *CTokenFilterer) FilterNewAdminFee(opts *bind.FilterOpts) (*CTokenNewAdminFeeIterator, error) {

	logs, sub, err := _CToken.contract.FilterLogs(opts, "NewAdminFee")
	if err != nil {
		return nil, err
	}
	return &CTokenNewAdminFeeIterator{contract: _CToken.contract, event: "NewAdminFee", logs: logs, sub: sub}, nil
}

// WatchNewAdminFee is a free log subscription operation binding the contract event 0xcdd0b588250e1398549f79cfdb8217c186688822905d6715b0834ea1c865594a.
//
// Solidity: event NewAdminFee(uint256 oldAdminFeeMantissa, uint256 newAdminFeeMantissa)
func (_CToken *CTokenFilterer) WatchNewAdminFee(opts *bind.WatchOpts, sink chan<- *CTokenNewAdminFee) (event.Subscription, error) {

	logs, sub, err := _CToken.contract.WatchLogs(opts, "NewAdminFee")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CTokenNewAdminFee)
				if err := _CToken.contract.UnpackLog(event, "NewAdminFee", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNewAdminFee is a log parse operation binding the contract event 0xcdd0b588250e1398549f79cfdb8217c186688822905d6715b0834ea1c865594a.
//
// Solidity: event NewAdminFee(uint256 oldAdminFeeMantissa, uint256 newAdminFeeMantissa)
func (_CToken *CTokenFilterer) ParseNewAdminFee(log types.Log) (*CTokenNewAdminFee, error) {
	event := new(CTokenNewAdminFee)
	if err := _CToken.contract.UnpackLog(event, "NewAdminFee", log); err != nil {
		return nil, err
	}
...
// CTokenNewFuseFeeIterator is returned from FilterNewFuseFee and is used to iterate over the raw logs and unpacked data for NewFuseFee events raised by the CToken contract.
type CTokenNewFuseFeeIterator struct {
	Event *CTokenNewFuseFee // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CTokenNewFuseFeeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CTokenNewFuseFeeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CTokenNewFuseFeeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CTokenNewFuseFee represents a NewFuseFee event raised by the CToken contract.
type CTokenNewFuseFee struct {
	OldFuseFeeMantissa *big.Int
	NewFuseFeeMantissa *big.Int
	Raw                types.Log // Blockchain specific contextual infos
}

// FilterNewFuseFee is a free log retrieval operation binding the contract event 0x92eef861b6533b7d3417f39c2ad7b460eed4e88a32fa3604f30e718b7602e7dc.
//
// Solidity: event NewFuseFee(uint256 oldFuseFeeMantissa, uint256 newFuseFeeMantissa)
func (_CToken *CTokenFilterer) FilterNewFuseFee(opts *bind.FilterOpts) (*CTokenNewFuseFeeIterator, error) {

	logs, sub, err := _CToken.contract.FilterLogs(opts, "NewFuseFee")
	if err != nil {
		return nil, err
	}
	return &CTokenNewFuseFeeIterator{contract: _CToken.contract, event: "NewFuseFee", logs: logs, sub: sub}, nil
}

// WatchNewFuseFee is a free log subscription operation binding the contract event 0x92eef861b6533b7d3417f39c2ad7b460eed4e88a32fa3604f30e718b7602e7dc.
//
// Solidity: event NewFuseFee(uint256 oldFuseFeeMantissa, uint256 newFuseFeeMantissa)
func (_CToken *CTokenFilterer) WatchNewFuseFee(opts *bind.WatchOpts, sink chan<- *CTokenNewFuseFee) (event.Subscription, error) {

	logs, sub, err := _CToken.contract.WatchLogs(opts, "NewFuseFee")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CTokenNewFuseFee)
				if err := _CToken.contract.UnpackLog(event, "NewFuseFee", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseNewFuseFee is a log parse operation binding the contract event 0x92eef861b6533b7d3417f39c2ad7b460eed4e88a32fa3604f30e718b7602e7dc.
//
// Solidity: event NewFuseFee(uint256 oldFuseFeeMantissa, uint256 newFuseFeeMantissa)
func (_CToken *CTokenFilterer) ParseNewFuseFee(log types.Log) (*CTokenNewFuseFee, error) {
	event := new(CTokenNewFuseFee)
	if err := _CToken.contract.UnpackLog(event, "NewFuseFee", log); err != nil {
		return nil, err
	}
